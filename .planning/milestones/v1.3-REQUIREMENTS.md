# Requirements Archive: v1.3 Data Cleaning Pipeline
...
- [x] **EXPO-02**: User can re-import a CONCERT export and see a confirmation modal offering to restore embedded reference lists and pipeline state
- [x] **EXPO-03**: User can see the multi-sheet export serve as both a standalone audit document and a CONCERT re-entry point
