...
- [x] **Phase 14: Multi-Sheet Export & Re-Import** - Export complete state as 7-sheet workbook, detect and restore CONCERT exports (completed 2026-03-09)
...
**Success Criteria** (what must be TRUE):
  ...
  3. User can re-import a CONCERT export and see a confirmation modal offering to restore embedded reference lists and pipeline state
  4. User can see the multi-sheet export serve as both a standalone audit document (readable in Excel) and a CONCERT re-entry point
