...
**Plans:** 3 plans
Plans:
- [ ] 42-01-PLAN.md -- Backend infrastructure: harmonization pre-checks, media map persistence, harmonize_media() API extension
...
| 42. Integration & Shiny Polish | v2.0 | 0/3 | Not started | - |
