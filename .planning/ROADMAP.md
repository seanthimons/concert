...
- [x] **Phase 42: Integration & Shiny Polish** -- RECO-01, RECO-02, MEDIT-01, MEDIT-02, MEDIT-03 (gap closure) (completed 2026-04-28)
...
Plans:
- [x] 41-01-PLAN.md -- Core harmonize_media() function, ENVO subset, and TDD tests
- [x] 41-02-PLAN.md -- AMOS build script with extraction, expansion, and cache enrichment
- [x] 41-03-PLAN.md -- Tag system + pipeline wiring in mod_harmonize.R and curate_headless.R
- [x] 41-04-PLAN.md -- Gap closure: fix dedup_step contract, stage ordering, NA warning, tag validation display
...
**Success Criteria** (what must be TRUE):
  1. Clicking "Run Pipeline" shows a modal listing each pipeline step with a fire/skip indicator based on pre-check results before any processing begins
...
- [x] 42-04-PLAN.md -- Gap closure: fix DT row click, add-mapping button, unmatched guidance, stale wording, hidden harmonize button
- [x] 42-05-PLAN.md -- Gap closure: pre-flight progress indicator and post-pipeline completion summary
