...
test_that("ComptoxR::clean_unicode handles chemistry-specific unicode", {
  # Test: Greek alpha becomes '.alpha.' (chemistry dot-notation, NOT 'a')
...
test_that("run_cleaning_pipeline produces chemistry dot-notation for Greek letters", {
  ...
  # Verify: Greek alpha becomes .alpha. notation
