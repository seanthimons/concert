...
# Load file
ifile = newest_file(globber="uncurated_chemicals*.csv", path=UAT_DIR)
...
data.to_excel(UAT_DIR / date_file("cleaned_chemicals_for_curation","xlsx"),index=False)
