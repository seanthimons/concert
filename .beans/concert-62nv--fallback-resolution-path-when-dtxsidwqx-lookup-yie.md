...
**Acceptance criteria:**
- [x] Detect rows where primary resolution (DTXSID + WQX) returned no match
- [x] Offer fallback query options (direct WQX search, direct DTXSID search)
- [x] Allow marking unresolvable records as 'bad' with a reason
- [x] Works in both Shiny UI and headless mode
